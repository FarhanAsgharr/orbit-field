...
import { InspectionStatus, type Role } from '@orbit/types';

import { AppError, ErrorCode, invalidTransition } from './errors.js';
import { type AccessSubject, can, Permission } from './rbac.js';
...
export const TRANSITIONS: readonly TransitionRule[] = [
  {
    from: InspectionStatus.DRAFT,
    to: InspectionStatus.SCHEDULED,
...

  {
    ...
    permission: Permission.INSPECTION_SUBMIT,
    guard: requireValidation,
  },
  {
    from: InspectionStatus.IN_PROGRESS,
    to: InspectionStatus.CANCELLED,
...

  {
    ...
    permission: Permission.INSPECTION_REVIEW,
  },
  {
    from: InspectionStatus.SUBMITTED,
  ...
  {
    from: InspectionStatus.UNDER_REVIEW,
    to: InspectionStatus.APPROVED,
    permission: Permission.INSPECTION_REVIEW,
  },
  {
  ...
  {
    from: InspectionStatus.REJECTED,
    to: InspectionStatus.IN_PROGRESS,
    permission: Permission.INSPECTION_UPDATE,
  },
  {
  ...
  {
    from: InspectionStatus.APPROVED,
    to: InspectionStatus.UNDER_REVIEW,
    permission: Permission.INSPECTION_REOPEN,
  },
  {
    from: InspectionStatus.APPROVED,
    to: InspectionStatus.ARCHIVED,
    permission: Permission.INSPECTION_ARCHIVE,
  },
  {
    from: InspectionStatus.CANCELLED,
    to: InspectionStatus.ARCHIVED,
    permission: Permission.INSPECTION_ARCHIVE,
  },
  {
...
export function assertTransitionResult(
  ...
  if (!can(ctx.subject, rule.permission))
