...
import { extraSecurityHeaders, originGuard, requestSanity, requireJsonBody } from './middleware/security.js';
...
import { assetsRouter, clientsRouter, projectsRouter, sitesRouter } from './modules/admin/reference.routes.js';
...
export function createApp(): Express {
  ...
  app.get('/health', (_req, res) => {
    res.json({ status: 'ok', service: 'orbit-backend', version: process.env.npm_package_version ?? '1.0.0' });
  });
