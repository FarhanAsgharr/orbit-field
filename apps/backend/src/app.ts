...
import { mountDocumentation } from './openapi/docs.routes.js';
...
export function createApp(): Express {
  ...
  /*
   * Documentation last, after every router is mounted.
   *
   * The document is generated by walking the routing table, so mounting this
   * earlier would describe a half-built server.
   */
